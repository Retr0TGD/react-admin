      ...
      <ProSidebar collapsed={isCollapsed}>
        <Menu iconShape="square">
          ...
          {!isCollapsed && (
            <Box mb="25px">
              ...
              <Box textAlign="center">
                <Typography color={colors.grey[100]} variant="h2" fontWeight="bold" sx={{ m: "10px 0 0 0" }}>
                  User
                </Typography>
          ...
          <Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            <Item to="/calendar" title="Calendar" icon={<CalendarTodayOutlinedIcon />} selected={selected} setSelected={setSelected} />
